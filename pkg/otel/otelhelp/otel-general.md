...
Sets the value of the [`service.name`](https://opentelemetry.io/docs/specs/semconv/resource/#service)
resource attribute.
...
[Resource SDK](https://opentelemetry.io/docs/specs/otel/resource/sdk#specifying-resource-information-via-an-environment-variable)
for more details.

**Default value:** Empty.

See
[Resource semantic conventions](https://opentelemetry.io/docs/specs/semconv/resource/#semantic-attributes-with-sdk-provided-default-value)
...
- `"b3"`: [B3 Single](https://opentelemetry.io/docs/specs/otel/context/api-propagators#configuration)
- `"b3multi"`:
  [B3 Multi](https://opentelemetry.io/docs/specs/otel/context/api-propagators#configuration)
- `"jaeger"`:
